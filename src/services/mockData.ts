...
export const mockMeetings: Meeting[] = [
  ...
  },
  {
    ...
    duration: "1:12:05",
    summary:
      "Workshop covered component standardization, token naming conventions, and migration plan from legacy styles. Team agreed on atomic design methodology.",
  },
  {
    id: "3",
  ...
  },
  {
    ...
    duration: "28:44",
    summary:
      "Root cause was an unmonitored memory leak in the cache layer. Action items include adding memory alerts and implementing circuit breakers.",
  },
  {
    id: "6",
...
export const mockActionItems: ActionItem[] = [
  {
    ...
    description:
      "Prepare WebSocket infrastructure proposal for collaboration features",
  ...
  },
  {
    ...
    meetingId: "1",
    meetingTitle: "Q1 Product Strategy Review",
    description: "Research competitor collaboration feature sets",
  ...
  },
  {
    ...
    meetingId: "1",
    meetingTitle: "Q1 Product Strategy Review",
    description: "Draft Q2 OKR document with collaboration focus",
    assignee: "Sarah Kim",
    status: "done",
  },
  {
    ...
    description: "Create component inventory spreadsheet",
  ...
  },
  {
    ...
    meetingId: "2",
    meetingTitle: "Design System Workshop",
    description: "Set up Storybook for new design tokens",
    assignee: "Priya Sharma",
    status: "done",
  },
  {
    id: "6",
    meetingId: "5",
    meetingTitle: "Infrastructure Post-Mortem",
    description: "Add memory usage alerts to monitoring dashboard",
    assignee: "Priya Sharma",
    status: "pending",
  },
  {
    ...
    meetingId: "5",
    meetingTitle: "Infrastructure Post-Mortem",
    description: "Implement circuit breaker pattern in cache layer",
    assignee: "Alex Rivera",
    status: "pending",
  },
  {
    ...
    meetingId: "5",
    meetingTitle: "Infrastructure Post-Mortem",
    description: "Write post-mortem document and share with engineering",
    assignee: "Marcus Chen",
    status: "done",
  },
];
